...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    if ($result1->num_rows > 0) {
      ...
      $sql_execute = "INSERT INTO users_logs (username, serialnumber, card_uid, device_uid, device_dep, checkindate, timein, timeout, card_out) VALUES ('$name','$serialnumber','$card_uid','bdb7b59d147ecce9','hoangan', '$d', '07:50:00', '00:00:00',0)";
